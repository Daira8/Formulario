...
var preguntas = [
 ...
 var opciones = [
     ...
     ["Harinas y cereales","Proteína de origen animal(carnes rojas, blancas o pescado)","Aceites y grasas","Ensaladas de verduras y/o frutas","Proteínas de origen vegetal (legumbres)"],
 ...
 function mostrarResultado(){
    ...
    document.getElementById("barra-progreso").value = indicePreg *100/(preguntas.length);

    cuadro.innerHTML = cuadro.innerHTML + "<h3>Resultados</h3>";
    ...
    cuadro.innerHTML = cuadro.innerHTML + 
    "<p class='resultado_obtenido'>Has obtenido "+puntaje+" puntos, lo cual significa que tu estilo de vida es "+estiloVida+".</p>";
}

function actualizarPuntaje(opcion){
    var indiceOpc = opcion - 1;
    puntaje = puntaje + puntajePorOpcion[indicePreg][indiceOpc];

    indicePreg=indicePreg+1;
...
function nuevaPregunta(){
    document.getElementById("pregunta").innerHTML = preguntas[indicePreg];
    document.getElementById("op1").innerHTML = opciones[indicePreg][0];
    document.getElementById("op2").innerHTML = opciones[indicePreg][1];
    document.getElementById("op3").innerHTML = opciones[indicePreg][2];
    document.getElementById("op4").innerHTML = opciones[indicePreg][3];
    document.getElementById("op5").innerHTML = opciones[indicePreg][4];
